...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\Login\\LoginController' => 'getLoginControllerService',
    ...
    {
        $this->services['App\\Controller\\Login\\LoginController'] = $instance = new \App\Controller\Login\LoginController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\Login\\LoginController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('22ifIJBUyM', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('semfL2p+Z4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => 'C:\\projet1\\src\\Entity']), 'App\\Entity');
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\projet1');
        $a->addPath('C:\\projet1\\vendor\\symfony\\framework-bundle/Resources/views', 'Framework');
        $a->addPath('C:\\projet1\\vendor\\symfony\\framework-bundle/Resources/views', '!Framework');
        $a->addPath('C:\\projet1\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\projet1\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\projet1\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\projet1\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\projet1\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\projet1\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\projet1\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('C:\\projet1\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('C:\\projet1/templates');
        $a->addPath('C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'C:\\projet1', 'UTF-8'));
    ...
    {
        return $this->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController(($this->services['router'] ?? $this->getRouterService()), ($this->services['profiler'] ?? $this->getProfilerService()), ($this->services['twig'] ?? $this->getTwigService()), $this->parameters['data_collector.templates'], ($this->privates['web_profiler.csp.handler'] ?? $this->getWebProfiler_Csp_HandlerService()), 'C:\\projet1');
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s6kWZNaJXc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1xjyZw6XhM', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CWqBVZKJMl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8qEMNUWieb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q3rVhNfdGs', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $this->privates['console.command.assets_install'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\AssetsInstallCommand(($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), 'C:\\projet1');
    ...
    {
        $this->privates['console.command.secrets_decrypt_to_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsDecryptToLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\projet1/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\projet1/.env.local'))));
    ...
    {
        $this->privates['console.command.secrets_encrypt_from_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsEncryptFromLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\projet1/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\projet1/.env.local'))));
    ...
    {
        $this->privates['console.command.secrets_generate_key'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsGenerateKeysCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\projet1/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\projet1/.env.local'))));
    ...
    {
        $this->privates['console.command.secrets_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsListCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\projet1/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\projet1/.env.local'))));
    ...
    {
        $this->privates['console.command.secrets_remove'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsRemoveCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\projet1/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\projet1/.env.local'))));
    ...
    {
        $this->privates['console.command.secrets_set'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsSetCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\projet1/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('C:\\projet1/.env.local'))));
    ...
    {
        $this->privates['console.command.translation_debug'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationDebugCommand(($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['translation.reader'] ?? $this->getTranslation_ReaderService()), ($this->privates['translation.extractor'] ?? $this->getTranslation_ExtractorService()), 'C:\\projet1/translations', 'C:\\projet1/templates', [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations'], [0 => 'C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Email', 1 => 'C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Form', 2 => 'C:\\projet1\\vendor\\symfony\\framework-bundle\\Command\\TranslationDebugCommand.php', 3 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Core\\Type\\FileType.php', 4 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Core\\Type\\TransformationFailureExtension.php', 5 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Validator\\Type\\UploadValidatorExtension.php', 6 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension.php', 7 => 'C:\\projet1\\vendor\\symfony\\validator\\ValidatorBuilder.php', 8 => 'C:\\projet1\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php', 9 => 'C:\\projet1\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php', 10 => 'C:\\projet1\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php']);
    ...
    protected function getConsole_Command_TranslationUpdateService()
    {
        ...
        $this->privates['console.command.translation_update'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationUpdateCommand($a, ($this->privates['translation.reader'] ?? $this->getTranslation_ReaderService()), ($this->privates['translation.extractor'] ?? $this->getTranslation_ExtractorService()), 'en', 'C:\\projet1/translations', 'C:\\projet1/templates', [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations'], [0 => 'C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Email', 1 => 'C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Form', 2 => 'C:\\projet1\\vendor\\symfony\\framework-bundle\\Command\\TranslationDebugCommand.php', 3 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Core\\Type\\FileType.php', 4 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Core\\Type\\TransformationFailureExtension.php', 5 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Validator\\Type\\UploadValidatorExtension.php', 6 => 'C:\\projet1\\vendor\\symfony\\form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension.php', 7 => 'C:\\projet1\\vendor\\symfony\\validator\\ValidatorBuilder.php', 8 => 'C:\\projet1\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php', 9 => 'C:\\projet1\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php', 10 => 'C:\\projet1\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php']);
    ...
    protected function getContainer_EnvVarProcessorService()
    {
        return $this->privates['container.env_var_processor'] = new \Symfony\Component\DependencyInjection\EnvVarProcessor($this, new RewindableGenerator(function () {
            yield 0 => ($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('C:\\projet1/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET'))));
        }, 1));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'C:\\projet1', function () {
    ...
    protected function getMaker_AutoCommand_MakeEntityService()
    {
        ...
        $this->privates['maker.auto_command.make_entity'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeEntity($a, ($this->privates['maker.doctrine_helper'] ?? $this->getMaker_DoctrineHelperService()), 'C:\\projet1', $b), $a, $b);
    ...
    {
        $this->privates['maker.auto_command.make_migration'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeMigration('C:\\projet1'), ($this->privates['maker.file_manager'] ?? $this->getMaker_FileManagerService()), ($this->privates['maker.generator'] ?? $this->getMaker_GeneratorService()));
    ...
    {
        return $this->privates['maker.file_manager'] = new \Symfony\Bundle\MakerBundle\FileManager(($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), new \Symfony\Bundle\MakerBundle\Util\AutoloaderUtil(new \Symfony\Bundle\MakerBundle\Util\ComposerAutoloaderFinder('App')), 'C:\\projet1', 'C:\\projet1/templates');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf'], 'ar' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'ca' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf'], 'eu' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf'], 'fr' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf'], 'id' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf'], 'nb' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf'], 'pt_BR' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf'], 'sr_Cyrl' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'vi' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf'], 'pt_PT' => [0 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations\\security.pt_PT.xlf']], 'scanned_directories' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations', 3 => 'C:\\projet1/translations', 4 => 'C:\\projet1\\vendor\\symfony\\framework-bundle/translations', 5 => 'C:\\projet1\\vendor\\symfony\\security-bundle/translations', 6 => 'C:\\projet1\\vendor\\symfony\\twig-bundle/translations', 7 => 'C:\\projet1\\vendor\\twig\\extra-bundle\\src/translations', 8 => 'C:\\projet1\\vendor\\symfony\\web-profiler-bundle/translations', 9 => 'C:\\projet1\\vendor\\symfony\\monolog-bundle/translations', 10 => 'C:\\projet1\\vendor\\symfony\\debug-bundle/translations', 11 => 'C:\\projet1\\vendor\\doctrine\\doctrine-bundle/translations', 12 => 'C:\\projet1\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 13 => 'C:\\projet1\\vendor\\sensio\\framework-extra-bundle\\src/translations', 14 => 'C:\\projet1\\vendor\\symfony\\maker-bundle\\src/translations'], 'cache_vary' => ['scanned_directories' => [0 => 'C:\\projet1\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\projet1\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\projet1\\vendor\\symfony\\security-core/Resources/translations', 3 => 'translations', 4 => 'C:\\projet1\\vendor\\symfony\\framework-bundle/translations', 5 => 'C:\\projet1\\vendor\\symfony\\security-bundle/translations', 6 => 'C:\\projet1\\vendor\\symfony\\twig-bundle/translations', 7 => 'C:\\projet1\\vendor\\twig\\extra-bundle\\src/translations', 8 => 'C:\\projet1\\vendor\\symfony\\web-profiler-bundle/translations', 9 => 'C:\\projet1\\vendor\\symfony\\monolog-bundle/translations', 10 => 'C:\\projet1\\vendor\\symfony\\debug-bundle/translations', 11 => 'C:\\projet1\\vendor\\doctrine\\doctrine-bundle/translations', 12 => 'C:\\projet1\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 13 => 'C:\\projet1\\vendor\\sensio\\framework-extra-bundle\\src/translations', 14 => 'C:\\projet1\\vendor\\symfony\\maker-bundle\\src/translations']]]);
    ...
    {
        $this->privates['twig.command.debug'] = $instance = new \Symfony\Bridge\Twig\Command\DebugCommand(($this->services['twig'] ?? $this->getTwigService()), 'C:\\projet1', $this->parameters['kernel.bundles_metadata'], 'C:\\projet1/templates', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    protected function getTwig_TemplateCacheWarmerService()
    {
        ...
        ]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel', 1)), ['C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Email' => 'email', 'C:\\projet1\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL], 'C:\\projet1/templates'));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'C:\\projet1\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\projet1\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\projet1\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\projet1\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\projet1\\vendor\\twig\\extra-bundle\\src',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\projet1\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\projet1\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\projet1\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\projet1\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\projet1\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'C:\\projet1\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\projet1\\vendor\\symfony\\maker-bundle\\src',
            ...
            'translator.default_path' => 'C:\\projet1/translations',
            ...
            'twig.default_path' => 'C:\\projet1/templates',
            ...
            'doctrine_migrations.dir_name' => 'C:\\projet1/src/Migrations',
